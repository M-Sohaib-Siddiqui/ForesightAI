...
export default function SignUpPage() {
  ...
  const handleInitiateSignUp = async (e?: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMsg(err.message || 'Could not send verification email. Please check your network connection.');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleResendOTP = async () => {
    ...
    try {
      ...
      setSuccessMsg('A new 6-digit verification code has been sent to your email inbox.');
    } catch (err: any) {
